...
[VolumeComponentMenu("Post-processing Custom/RadianceCascadeGI")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(RadianceCascadeGIRendererFeature))]
...
public sealed class RadianceCascadeGIVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public RadianceCascadeGIVolumeComponent()
    {
        displayName = "RadianceCascadeGI";
    }
