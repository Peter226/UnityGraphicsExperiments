...
[VolumeComponentMenu("Post-processing Custom/RadianceTreeGI")]
...
public sealed class RadianceTreeGIVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public RadianceTreeGIVolumeComponent()
    {
        displayName = "RadianceTreeGI";
    }
